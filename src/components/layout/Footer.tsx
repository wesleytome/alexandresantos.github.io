  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-20 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-full" style={{ backgroundColor: 'rgba(250, 250, 250, 0.2)', color: '#FAFAFA' }}>
                <span className="text-xl font-bold">DA</span>
              </div>
              <div className="flex flex-col">
                <span className="text-lg font-body font-semibold" style={{ color: '#FAFAFA' }}>
                  {businessInfo.name}
                </span>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-body font-semibold" style={{ color: '#FAFAFA' }}>Institucional</h3>
            ...
            <Separator style={{ backgroundColor: 'rgba(250, 250, 250, 0.2)' }} />
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
          ...
          {/* Coluna 3: Serviços */}
          <div className="space-y-4">
            <h3 className="text-lg font-body font-semibold" style={{ color: '#FAFAFA' }}>Serviços</h3>
            <ul className="space-y-2">
          ...
          {/* Coluna 4: Horários */}
          <div className="space-y-4">
            <h3 className="text-lg font-body font-semibold" style={{ color: '#FAFAFA' }}>Horários</h3>
            <Table>
              <TableBody>
                <TableRow style={{ borderColor: 'rgba(250, 250, 250, 0.2)' }}>
        ...
        <Separator className="my-8" style={{ backgroundColor: 'rgba(250, 250, 250, 0.2)' }} />
